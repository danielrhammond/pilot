...
/// Common baseclass for scrollable collections of models (ex: (NS)CollectionViewController, (NS)TableViewController).
open class ModelCollectionViewController: NSViewController {

    internal init(model: ModelCollection, context: Context) {
    ...
    @available(*, unavailable, message: "Use `init(model:context:)`")
...
fileprivate final class FullWidthScrollView: NSScrollView {
    ...
    /*
     ...
     TODO:(danielh) figure out why this breaks scrolling for outline views 
